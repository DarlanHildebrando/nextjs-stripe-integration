...
export default function HalfPrice({free, paid}){
                ...
                {MeiaEntradaCheck && !free && <>
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-5 w-full mt-5">
                        <div className="flex flex-col gap-1">
                            ...
                            <input className="border border-gray-400 rounded-sm p-3 w-full" type="text" placeholder="Ingresso único, VIP, etc..." />
                        </div>
                        <div className="flex flex-col gap-1">
                            <label htmlFor="">Quantidade</label>
                            <input className="border border-gray-400 rounded-sm p-3 w-full" type="text" placeholder="Ex: 100" />
                        </div>
                    </div>
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-5 w-full mt-5">
                        <div className="flex flex-col gap-1">
                            <label htmlFor="">Valor a receber</label>
                            <input className="border border-gray-400 rounded-sm p-3 w-full" type="text" placeholder="R$" />
                        </div>
                        <div className="flex flex-col gap-1">
